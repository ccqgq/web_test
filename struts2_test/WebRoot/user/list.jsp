...
<HTML>
	...
	<body>
		<br>
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user_listselect" method="post">
									...
									<s:iterator value="%{users}" var="u">
										...
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/user_updatefind?userID=<s:property value='%{#u.userID}'/>">
													<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/user_findone?userID=<s:property value='%{#u.userID}'/>">
													<img src="${pageContext.request.contextPath}/images/button_view.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath }/user_delete?userID=<s:property value='%{#u.userID}'/>">
