...
<body>
	<form action="${pageContext.request.contextPath }/showByPage.do" method="post">
	...
	<table class="table table-striped" style="width: 60%" align="center">
		...
		<tr>
			<td colspan="7" align="center">
				<a href="${pageContext.request.contextPath }/showByPage.do?pageNum=1">首页</a>
				<c:choose >
					<c:when test="${pageCus_msg.pageNum ne 1 }">
						<a href="${pageContext.request.contextPath }/showByPage.do?pageNum=${pageCus_msg.pageNum-1}">上一页</a>
					</c:when>
					<c:otherwise>
						<a>上一页</a>
					</c:otherwise>
				...
				<c:choose>
					...
					<c:otherwise>
						<a href="${pageContext.request.contextPath }/showByPage.do?pageNum=${pageCus_msg.pageNum+1}">下一页</a>
					</c:otherwise>
				</c:choose>
				<a href="${pageContext.request.contextPath }/showByPage.do?pageNum=${pageCus_msg.pageSum}">尾页</a>
			</td>
		</tr>
	</table>
	</form>
